...
set GAFFER_ROOT=C:\gaffer\gaffer-%1%
set GAFFER_EXTENSION_PATHS=%~dp0%
set DEADLINE_DEPENDENCY_SCRIPT_PATH=%~dp0%/gaffer_batch_dependency.py

set PYTHONUTF8=1

set ARNOLD_LICENSE_ORDER=none
...
"C:\Users\eric.HYPOTHETICAL\AppData\Local\Programs\Microsoft VS Code\Code.exe"
@REM "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\Common7\IDE\devenv.exe"
